  ...
  return (
    <section className='mt-16 mx-auto bg-primary p-5 text-white text-center space-y-5'>
      ...
      <div className='flex justify-center items-center space-x-4'>
        <a target='_blank' href='https://www.facebook.com/chrispydev1/'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='22'
            height='22'
            fill='currentColor'
            className='transition hover:text-secondary bi bi-facebook'
            viewBox='0 0 16 16'
          >
        ...
        <a target='_blank' href='https://twitter.com/chrispydev1'>
          <svg
            ...
            height='22'
            fill='currentColor'
            className='transition hover:text-secondary bi bi-twitter'
            viewBox='0 0 16 16'
          >
        ...
        <a target='_blank' href='https://www.instagram.com/chrispydev/'>
          <svg
            ...
            height='22'
            fill='currentColor'
            className='transition hover:text-secondary bi bi-instagram'
            viewBox='0 0 16 16'
          >
        ...
        <a target='_blank' href='https://github.com/chrispydev'>
          <svg
            ...
            height='22'
            fill='currentColor'
            className='transition hover:text-secondary bi bi-github'
            viewBox='0 0 16 16'
          >
        ...
        >
          <svg
            ...
            height='22'
            fill='currentColor'
            className='transition hover:text-secondary bi bi-linkedin'
            viewBox='0 0 16 16'
          >
