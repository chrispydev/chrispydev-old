          ...
          <div className="mt-8">
            ...
            <ul className="uses-container">
              <li>
                ...
                websites for free and even add a domain name as well. And I have
                being using this for more two days before moving to vercel and
                netlify.
              </li>
              <li>
                ...
                hosting, they offer a wide rages of functions which are known as
                serverless functions. They do all the hardwork and the logic for
                you.
              </li>
